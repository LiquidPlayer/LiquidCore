...
const usage = (() => {
  /*
  Usage:
    npm run bundler [<entry-file>] <out> [-- options]
  ...
  Examples:
    npm run bundler index.js ~/index.bundle.js
    npm run bundler lib/foo.js ~/foo.bundle -- --reset-cache --dev --platform=ios
    npm run bundler ~/project_dir/res/raw -- --platform=android
