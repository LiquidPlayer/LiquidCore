...
public class MicroServiceTest {
    ...
    public void TestAddOn() throws Exception {
        ...
        final URI serviceURI = URI.create("file:///android_asset/addon.js");

        final MicroService addon = new MicroService(InstrumentationRegistry.getContext(), serviceURI,
                new MicroService.ServiceStartListener() {
                    @Override
                    public void onStart(MicroService service) {
                        service.addEventListener("assert", new MicroService.EventListener() {
                            @Override
                            public void onEvent(MicroService service, String event, JSONObject payload) {
                                try {
                                    String expected = payload.get("expected").toString();
                                    String value = payload.get("value").toString();
                                    android.util.Log.d("TestAddOn", "assert: Expected " + expected + ", got " + value);
