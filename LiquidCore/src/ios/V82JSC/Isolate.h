...
struct IsolateImpl {
    ...
    intptr_t m_isolate_id;
    JSContextGroupRef m_group;
    v8::Persistent<v8::Context> m_nullContext;
    JSGlobalContextRef m_nullContextRef;
    ...
    v8::AllowWasmCodeGenerationCallback m_allow_wasm_code_generation_callback;
    ...
    v8::AllowCodeGenerationFromStringsCallback m_allow_code_gen_callback;
    bool m_disallow_js;
