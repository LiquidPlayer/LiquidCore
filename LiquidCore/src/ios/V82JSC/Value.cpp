...
bool v8::Value::IsInt32() const
{
    ...
    MaybeLocal<Number> num = ToNumber(ToCurrentContext(this));
    if (!num.IsEmpty()) {
        FROMTHIS(c,v);
 ...
 */
IS(IsMapIterator, "let s = (new Map())[Symbol.iterator](); return typeof _1 === 'object' && s.isPrototypeOf(_1)")

/**
 * Returns true if this value is a Set Iterator.
 */
IS(IsSetIterator, "let s = (new Set())[Symbol.iterator](); return typeof _1 === 'object' && s.isPrototypeOf(_1)")
