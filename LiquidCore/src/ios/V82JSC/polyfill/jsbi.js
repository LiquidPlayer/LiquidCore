...
if (global.BigInt === undefined) {
  ...
  {
    return JSBI.BigInt(...arguments);
  }
  global.BigInt.asIntN = function()
  {
    return JSBI.asIntN(...arguments);
  }
  global.BigInt.asUintN = function()
  {
    return JSBI.asUintN(...arguments);
  }
  global.BigInt.isBigInt = function(n) {
    return (typeof n === 'object' && n instanceof JSBI);
  }
  global.BigInt.__proto__ = JSBI;

  let origNumber = Number;
  Number = function(n) {
    if (typeof n === 'object' && n instanceof JSBI) {
      return JSBI.toNumber(n);
    } else {
      return origNumber(n);
    }
  }
  global.Number.__proto__ = origNumber;
}
...
if (!global.BigUint64Array) {
  global.BigUint64Array = Float64Array;
}
if (!global.BigInt64Array) {
  global.BigInt64Array = Float64Array;
}
