...
Local<v8::FunctionTemplate> v8::FunctionTemplate::NewWithCache(
                                            ...
                                            Local<v8::Signature> signature, int length, SideEffectType side_effect_type)
{
...
void v8::FunctionTemplate::SetCallHandler(FunctionCallback callback,
                    Local<Value> data, SideEffectType side_effect_type)
{
                                                           ...
                                                           JSValueRef *exception)
{
    ...
    v8::internal::Object * implicit[] = {
        ...
        * reinterpret_cast<v8::internal::Object**>(*target)  // kNewTargetIndex = 5;
    };
