...
public class JSFloat32ArrayTest {
    ...
    @Test
    public void testJSFloat32Array() {
        ...
        assertTrue(array.isFloat32Array());
        ...
        assertEquals(Float.valueOf(2f), last1);
        assertEquals(Float.valueOf(20f), list.get(1));
        ...
        it.next();
        it.set(100f);
        assertEquals(Float.valueOf(100f), list.get(0));
        ...
        assertEquals(Float.valueOf(1f), it2.next());
