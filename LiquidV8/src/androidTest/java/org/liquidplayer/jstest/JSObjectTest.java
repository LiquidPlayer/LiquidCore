...
public class JSObjectTest {
    ...
    @org.junit.Test
    public void testJSObjectConstructors() {
        JSContext context = new JSContext();
        testJSObjectConstructors(context);
    }

    public void testJSObjectConstructors(JSContext context) {
    ...
    @org.junit.Test
    public void testJSObjectProperties() {
        JSContext context = new JSContext();
        testJSObjectProperties(context);
    }

    public void testJSObjectProperties(JSContext context) {
         ...
         */
        object.property("added",3, JSObject.JSPropertyAttributeNone);
        assertTrue(object.hasProperty("added"));
        assertEquals(object.property("added"),new JSValue(context,3));
        object.property("added", 10);
        assertEquals(object.property("added"),new JSValue(context,10));
    ...
    @org.junit.Test
    public void testJSObjectTesters() {
        JSContext context = new JSContext();
        testJSObjectTesters(context);
    }

    public void testJSObjectTesters(JSContext context) {
    ...
    public void issue31Test(JSContext context) {
