...
public class JSUint16ArrayTest {
    ...
    public void testJSUint16Array() {
        ...
        assertTrue(array.isUint16Array());
        ...
        assertEquals(Short.valueOf((short)2), last1);
        assertEquals(Short.valueOf((short)20), list.get(1));
        ...
        it.next();
        it.set((short)100);
        assertEquals(Short.valueOf((short)100), list.get(0));
        ...
        assertEquals(Short.valueOf((short)1), it2.next());
