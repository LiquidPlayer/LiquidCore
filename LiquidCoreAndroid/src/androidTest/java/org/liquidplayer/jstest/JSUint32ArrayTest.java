...
public class JSUint32ArrayTest {
    ...
    public void testJSUint32Array() {
        ...
        assertTrue(array.isUint32Array());
        ...
        assertEquals(Long.valueOf(2), last1);
        ...
        it.next();
        it.set((long)100);
        assertEquals(Long.valueOf(100), list.get(0));
        ...
        assertEquals(Long.valueOf(1), it2.next());
