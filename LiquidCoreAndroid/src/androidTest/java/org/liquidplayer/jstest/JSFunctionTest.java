...
public class JSFunctionTest {
    ...
    public static class PrototypeObject extends JSObject implements IPrototypeObject {
        PrototypeObject(JSContext context) {
    ...
    public class ConstructorFunction extends JSFunction {
        ConstructorFunction(JSContext ctx) {
    ...
    public class TestFunction extends JSFunction {
        TestFunction(JSContext ctx) throws NoSuchMethodException {
    ...
    public class TestFunction3 extends JSFunction {
        TestFunction3(JSContext ctx) throws NoSuchMethodException {
    ...
    @org.junit.Test
    public void testJSFunctionCallback() {
        JSContext context = new JSContext();
        testJSFunctionCallback(context);
    }

    public void testJSFunctionCallback(JSContext context) {
    ...
    private /* do not make it static! */ class TestInstance2 extends JSObject {
    }
    ...
    public static class InstantiationExceptionFail extends JSObject {
        public InstantiationExceptionFail(Integer foo) {
            assertNull(foo);
        }
    }

    public class TestFunction2 extends JSFunction {
        TestFunction2(JSContext ctx, Class<? extends JSObject> c) throws NoSuchMethodException {
    ...
    @org.junit.Test
    public void issue15Test() {
        JSContext context = new JSContext();
        issue15Test(context);
    }

    public void issue15Test(JSContext context) {
    ...
    @org.junit.Test
    public void varArgFunctionsTest() {
        JSContext context = new JSContext();
        JSFunction varArgFunction = new JSFunction(context, "varArgFunction") {
            ...
            public String varArgFunction(int a, String b, JSValue... vars) {
                ...
                if (vars != null) {
                    for (JSValue var : vars) {
                        result.append(" ").append(var.toString());
                    }
                }
